...
<div class="container">
		<fieldset>
			<legend><spring:message code="passagers.fieldset"/></legend>
			<table class="table table-striped">
				...
				<c:forEach items="${passagers}" var="passager">
					<tr>
						...
						<td><a href="edit?id=${passager.id}" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-pencil"></span></a></td>
						<td><a href="delete?id=${passager.id}" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash"></span></a></td>
					</tr>
				</c:forEach>
				<tr>
