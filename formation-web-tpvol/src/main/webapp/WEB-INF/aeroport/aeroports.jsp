...
<body>
	...
	<div class="container">
		<fieldset>
			<legend>
				<spring:message code="aeroports.fieldset" />
			</legend>
			<table class="table table-striped">
				...
				<c:forEach items="${aeroports}" var="aeroport">
					<tr>
						...
						<td>${aeroport.nom}</td>
						<td><a href="listvilles?id=${aeroport.id}"><span
								class="glyphicon glyphicon-home"></span></a></td>
						<%-- <td><a href="listvilles?id=${aeroport.id}" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-home"></span></a></td> --%>
						<td><a href="delete?id=${aeroport.id}"
							class="btn btn-danger btn-xs"><span
								class="glyphicon glyphicon-trash"></span></a></td>
					</tr>
				</c:forEach>
				<tr>
					<td colspan="5"><a href="add" class="btn btn-success btn-sm"><span
